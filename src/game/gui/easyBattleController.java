...
public class easyBattleController {
 ...
 Image wallTrapi=new Image("WallTrap (2).png");
   ...
   public easyBattleController()throws IOException{};
        Battle battle=new Battle(0,0,23,3,250);
...
public static void setFinalScore(int finalScore) {
	easyBattleController.finalScore = finalScore;
}
...
public void showGameOverMessage(ActionEvent e) throws IOException{
	Parent root = FXMLLoader.load(getClass().getResource("GameOverMessageE.fxml"));
